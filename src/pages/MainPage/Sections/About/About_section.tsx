...
const About_section = () => {
  return (
    <section className={`${style.about__section} `}>
        <TitleComponent title='about' text="“We're one of the best furniture agency. Prioritizing customers and making purchases easy are the hallmarks of our agency.”" />
